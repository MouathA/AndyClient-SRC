...
{
    private static Map s_OutstandingBuffers;
    protected long m_NativeAddress;
    protected int m_Size;
    protected StreamAPI m_API;
    
    public static FrameBuffer lookupBuffer(final long n) {
        return FrameBuffer.s_OutstandingBuffers.get(n);
    }
    ...
    static {
        FrameBuffer.s_OutstandingBuffers = new HashMap();
    }
}
