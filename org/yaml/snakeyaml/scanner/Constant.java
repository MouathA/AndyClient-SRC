...
public final class Constant
{
    ...
    private Constant(final String s) {
    ...
    public boolean hasNo(final int n) {
        return !this.has(n);
    }
    
    public boolean has(final int n, final String s) {
        return this.has(n) || s.indexOf(n, 0) != -1;
    }
    
    public boolean hasNo(final int n, final String s) {
        return !this.has(n, s);
    }
