...
public class ContextedRuntimeException extends RuntimeException implements ExceptionContext
{
    ...
    public ContextedRuntimeException(final String s) {
        super(s);
        this.exceptionContext = new DefaultExceptionContext();
    }
    
    public ContextedRuntimeException(final Throwable t) {
        super(t);
        this.exceptionContext = new DefaultExceptionContext();
    }
    
    public ContextedRuntimeException(final String s, final Throwable t) {
        super(s, t);
        this.exceptionContext = new DefaultExceptionContext();
    }
    
    public ContextedRuntimeException(final String s, final Throwable t, ExceptionContext exceptionContext) {
        super(s, t);
    ...
    @Override
    public ContextedRuntimeException addContextValue(final String s, final Object o) {
        this.exceptionContext.addContextValue(s, o);
        return this;
    }
    
    @Override
    public ContextedRuntimeException setContextValue(final String s, final Object o) {
