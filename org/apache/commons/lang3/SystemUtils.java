...
public class SystemUtils
{
    ...
    static boolean isJavaVersionMatch(final String s, final String s2) {
        return s != null && s.startsWith(s2);
    }
    
    static boolean isOSMatch(final String s, final String s2, final String s3, final String s4) {
        return s != null && s2 != null && s.startsWith(s3) && s2.startsWith(s4);
    }
    
    static boolean isOSNameMatch(final String s, final String s2) {
        return s != null && s.startsWith(s2);
    }
