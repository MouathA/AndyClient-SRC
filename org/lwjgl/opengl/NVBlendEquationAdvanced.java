...
public final class NVBlendEquationAdvanced
{
    ...
    public static void glBlendParameteriNV(final int n, final int n2) {
        final long glBlendParameteriNV = GLContext.getCapabilities().glBlendParameteriNV;
        BufferChecks.checkFunctionAddress(glBlendParameteriNV);
        nglBlendParameteriNV(n, n2, glBlendParameteriNV);
    }
    
    static native void nglBlendParameteriNV(final int p0, final int p1, final long p2);
    
    public static void glBlendBarrierNV() {
        final long glBlendBarrierNV = GLContext.getCapabilities().glBlendBarrierNV;
        BufferChecks.checkFunctionAddress(glBlendBarrierNV);
        nglBlendBarrierNV(glBlendBarrierNV);
    }
