...
public final class EXTShaderImageLoadStore
{
    ...
    public static void glBindImageTextureEXT(final int n, final int n2, final int n3, final boolean b, final int n4, final int n5, final int n6) {
        final long glBindImageTextureEXT = GLContext.getCapabilities().glBindImageTextureEXT;
        BufferChecks.checkFunctionAddress(glBindImageTextureEXT);
        nglBindImageTextureEXT(n, n2, n3, b, n4, n5, n6, glBindImageTextureEXT);
    }
    ...
    public static void glMemoryBarrierEXT(final int n) {
        final long glMemoryBarrierEXT = GLContext.getCapabilities().glMemoryBarrierEXT;
        BufferChecks.checkFunctionAddress(glMemoryBarrierEXT);
        nglMemoryBarrierEXT(n, glMemoryBarrierEXT);
    }
