...
public final class RenderTexture
{
    ...
    public RenderTexture(final boolean b, final boolean b2, final boolean b3, final boolean b4, final int n, final int n2) {
        if (b && b2) {
