...
final class LinuxEvent
{
    ...
    public void copyFrom(final LinuxEvent linuxEvent) {
        final int position = this.event_buffer.position();
        final int position2 = linuxEvent.event_buffer.position();
    ...
    public void sendEvent(final long n, final long n2, final boolean b, final long n3) {
        nSendEvent(this.event_buffer, n, n2, b, n3);
    }
    
    private static native void nSendEvent(final ByteBuffer p0, final long p1, final long p2, final boolean p3, final long p4);
    
    public boolean filterEvent(final long n) {
        return nFilterEvent(this.event_buffer, n);
    }
    
    private static native boolean nFilterEvent(final ByteBuffer p0, final long p1);
    
    public void nextEvent(final long n) {
        nNextEvent(n, this.event_buffer);
    }
    ...
    public void setWindow(final long n) {
        nSetWindow(this.event_buffer, n);
    }
    ...
    public int getClientData(final int n) {
        return nGetClientData(this.event_buffer, n);
    }
