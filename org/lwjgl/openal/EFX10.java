...
public final class EFX10
{
    ...
    public static void alGenAuxiliaryEffectSlots(final IntBuffer intBuffer) {
        BufferChecks.checkDirect(intBuffer);
        nalGenAuxiliaryEffectSlots(intBuffer.remaining(), MemoryUtil.getAddress(intBuffer));
    }
    ...
    public static void alDeleteAuxiliaryEffectSlots(final IntBuffer intBuffer) {
        BufferChecks.checkDirect(intBuffer);
        nalDeleteAuxiliaryEffectSlots(intBuffer.remaining(), MemoryUtil.getAddress(intBuffer));
    }
    
    static native void nalDeleteAuxiliaryEffectSlots(final int p0, final long p1);
    
    public static void alDeleteAuxiliaryEffectSlots(final int n) {
        nalDeleteAuxiliaryEffectSlots2(1, n);
    }
    
    static native void nalDeleteAuxiliaryEffectSlots2(final int p0, final int p1);
    
    public static boolean alIsAuxiliaryEffectSlot(final int n) {
        return nalIsAuxiliaryEffectSlot(n);
    }
    
    static native boolean nalIsAuxiliaryEffectSlot(final int p0);
    
    public static void alAuxiliaryEffectSloti(final int n, final int n2, final int n3) {
        nalAuxiliaryEffectSloti(n, n2, n3);
    }
    
    static native void nalAuxiliaryEffectSloti(final int p0, final int p1, final int p2);
    
    public static void alAuxiliaryEffectSlot(final int n, final int n2, final IntBuffer intBuffer) {
        BufferChecks.checkBuffer(intBuffer, 1);
        nalAuxiliaryEffectSlotiv(n, n2, MemoryUtil.getAddress(intBuffer));
    }
    
    static native void nalAuxiliaryEffectSlotiv(final int p0, final int p1, final long p2);
    
    public static void alAuxiliaryEffectSlotf(final int n, final int n2, final float n3) {
        nalAuxiliaryEffectSlotf(n, n2, n3);
    }
    
    static native void nalAuxiliaryEffectSlotf(final int p0, final int p1, final float p2);
    
    public static void alAuxiliaryEffectSlot(final int n, final int n2, final FloatBuffer floatBuffer) {
        BufferChecks.checkBuffer(floatBuffer, 1);
        nalAuxiliaryEffectSlotfv(n, n2, MemoryUtil.getAddress(floatBuffer));
    }
    
    static native void nalAuxiliaryEffectSlotfv(final int p0, final int p1, final long p2);
    
    public static int alGetAuxiliaryEffectSloti(final int n, final int n2) {
        return nalGetAuxiliaryEffectSloti(n, n2);
    }
    
    static native int nalGetAuxiliaryEffectSloti(final int p0, final int p1);
    
    public static void alGetAuxiliaryEffectSlot(final int n, final int n2, final IntBuffer intBuffer) {
        BufferChecks.checkBuffer(intBuffer, 1);
        nalGetAuxiliaryEffectSlotiv(n, n2, MemoryUtil.getAddress(intBuffer));
    }
    
    static native void nalGetAuxiliaryEffectSlotiv(final int p0, final int p1, final long p2);
    
    public static float alGetAuxiliaryEffectSlotf(final int n, final int n2) {
        return nalGetAuxiliaryEffectSlotf(n, n2);
    }
    
    static native float nalGetAuxiliaryEffectSlotf(final int p0, final int p1);
    
    public static void alGetAuxiliaryEffectSlot(final int n, final int n2, final FloatBuffer floatBuffer) {
        BufferChecks.checkBuffer(floatBuffer, 1);
        nalGetAuxiliaryEffectSlotfv(n, n2, MemoryUtil.getAddress(floatBuffer));
    }
    
    static native void nalGetAuxiliaryEffectSlotfv(final int p0, final int p1, final long p2);
    
    public static void alGenEffects(final IntBuffer intBuffer) {
        BufferChecks.checkDirect(intBuffer);
        nalGenEffects(intBuffer.remaining(), MemoryUtil.getAddress(intBuffer));
    }
    ...
    public static void alDeleteEffects(final IntBuffer intBuffer) {
        BufferChecks.checkDirect(intBuffer);
        nalDeleteEffects(intBuffer.remaining(), MemoryUtil.getAddress(intBuffer));
    }
    
    static native void nalDeleteEffects(final int p0, final long p1);
    
    public static void alDeleteEffects(final int n) {
        nalDeleteEffects2(1, n);
    }
    
    static native void nalDeleteEffects2(final int p0, final int p1);
    
    public static boolean alIsEffect(final int n) {
        return nalIsEffect(n);
    }
    
    static native boolean nalIsEffect(final int p0);
    
    public static void alEffecti(final int n, final int n2, final int n3) {
        nalEffecti(n, n2, n3);
    }
    
    static native void nalEffecti(final int p0, final int p1, final int p2);
    
    public static void alEffect(final int n, final int n2, final IntBuffer intBuffer) {
        BufferChecks.checkBuffer(intBuffer, 1);
        nalEffectiv(n, n2, MemoryUtil.getAddress(intBuffer));
    }
    
    static native void nalEffectiv(final int p0, final int p1, final long p2);
    
    public static void alEffectf(final int n, final int n2, final float n3) {
        nalEffectf(n, n2, n3);
    }
    
    static native void nalEffectf(final int p0, final int p1, final float p2);
    
    public static void alEffect(final int n, final int n2, final FloatBuffer floatBuffer) {
        BufferChecks.checkBuffer(floatBuffer, 1);
        nalEffectfv(n, n2, MemoryUtil.getAddress(floatBuffer));
    }
    
    static native void nalEffectfv(final int p0, final int p1, final long p2);
    
    public static int alGetEffecti(final int n, final int n2) {
        return nalGetEffecti(n, n2);
    }
    
    static native int nalGetEffecti(final int p0, final int p1);
    
    public static void alGetEffect(final int n, final int n2, final IntBuffer intBuffer) {
        BufferChecks.checkBuffer(intBuffer, 1);
        nalGetEffectiv(n, n2, MemoryUtil.getAddress(intBuffer));
    }
    
    static native void nalGetEffectiv(final int p0, final int p1, final long p2);
    
    public static float alGetEffectf(final int n, final int n2) {
        return nalGetEffectf(n, n2);
    }
    
    static native float nalGetEffectf(final int p0, final int p1);
    
    public static void alGetEffect(final int n, final int n2, final FloatBuffer floatBuffer) {
        BufferChecks.checkBuffer(floatBuffer, 1);
        nalGetEffectfv(n, n2, MemoryUtil.getAddress(floatBuffer));
    }
    
    static native void nalGetEffectfv(final int p0, final int p1, final long p2);
    
    public static void alGenFilters(final IntBuffer intBuffer) {
        BufferChecks.checkDirect(intBuffer);
        nalGenFilters(intBuffer.remaining(), MemoryUtil.getAddress(intBuffer));
    }
    ...
    public static void alDeleteFilters(final IntBuffer intBuffer) {
        BufferChecks.checkDirect(intBuffer);
        nalDeleteFilters(intBuffer.remaining(), MemoryUtil.getAddress(intBuffer));
    }
    
    static native void nalDeleteFilters(final int p0, final long p1);
    
    public static void alDeleteFilters(final int n) {
        nalDeleteFilters2(1, n);
    }
    
    static native void nalDeleteFilters2(final int p0, final int p1);
    
    public static boolean alIsFilter(final int n) {
        return nalIsFilter(n);
    }
    
    static native boolean nalIsFilter(final int p0);
    
    public static void alFilteri(final int n, final int n2, final int n3) {
        nalFilteri(n, n2, n3);
    }
    
    static native void nalFilteri(final int p0, final int p1, final int p2);
    
    public static void alFilter(final int n, final int n2, final IntBuffer intBuffer) {
        BufferChecks.checkBuffer(intBuffer, 1);
        nalFilteriv(n, n2, MemoryUtil.getAddress(intBuffer));
    }
    
    static native void nalFilteriv(final int p0, final int p1, final long p2);
    
    public static void alFilterf(final int n, final int n2, final float n3) {
        nalFilterf(n, n2, n3);
    }
    
    static native void nalFilterf(final int p0, final int p1, final float p2);
    
    public static void alFilter(final int n, final int n2, final FloatBuffer floatBuffer) {
        BufferChecks.checkBuffer(floatBuffer, 1);
        nalFilterfv(n, n2, MemoryUtil.getAddress(floatBuffer));
    }
    
    static native void nalFilterfv(final int p0, final int p1, final long p2);
    
    public static int alGetFilteri(final int n, final int n2) {
        return nalGetFilteri(n, n2);
    }
    
    static native int nalGetFilteri(final int p0, final int p1);
    
    public static void alGetFilter(final int n, final int n2, final IntBuffer intBuffer) {
        BufferChecks.checkBuffer(intBuffer, 1);
        nalGetFilteriv(n, n2, MemoryUtil.getAddress(intBuffer));
    }
    
    static native void nalGetFilteriv(final int p0, final int p1, final long p2);
    
    public static float alGetFilterf(final int n, final int n2) {
        return nalGetFilterf(n, n2);
    }
    
    static native float nalGetFilterf(final int p0, final int p1);
    
    public static void alGetFilter(final int n, final int n2, final FloatBuffer floatBuffer) {
        BufferChecks.checkBuffer(floatBuffer, 1);
        nalGetFilterfv(n, n2, MemoryUtil.getAddress(floatBuffer));
    }
