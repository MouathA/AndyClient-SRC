...
final class FastLongMap implements Iterable
{
    ...
    FastLongMap(final int n) {
        this(n, 0.75f);
    }
    
    FastLongMap(final int n, final float n2) {
        if (n > 1073741824) {
    ...
    private int index(final long n) {
        return index(n, this.mask);
    }
    
    private static int index(final long n, final int n2) {
        return (int)(n ^ n >>> 32) & n2;
    }
    ...
    static Entry[] access$000(final FastLongMap fastLongMap) {
        return fastLongMap.table;
    }
    ...
    public class EntryIterator implements Iterator
    {
        ...
        EntryIterator(final FastLongMap this$0) {
            this.this$0 = this$0;
            this.reset();
        }
        ...
        public void reset() {
            ...
            Entry[] access$000;
            int nextIndex;
            for (access$000 = FastLongMap.access$000(this.this$0), nextIndex = access$000.length - 1; nextIndex >= 0 && access$000[nextIndex] == null; --nextIndex) {}
        ...
        public Entry next() {
            ...
            final Entry[] access$000 = FastLongMap.access$000(this.this$0);
