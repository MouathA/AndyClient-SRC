...
public abstract class TIntByteHash extends TPrimitiveHash
{
    ...
    public TIntByteHash(final int n) {
        super(n);
        this.no_entry_key = 0;
        this.no_entry_value = 0;
    }
    
    public TIntByteHash(final int n, final float n2) {
        super(n, n2);
        this.no_entry_key = 0;
        this.no_entry_value = 0;
    }
    
    public TIntByteHash(final int n, final float n2, final int no_entry_key, final byte no_entry_value) {
        super(n, n2);
