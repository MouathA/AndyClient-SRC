...
final class ButtonUsage implements Usage
{
    ...
    public static final ButtonUsage map(final int n) {
        final Integer n2 = new Integer(n);
        final ButtonUsage buttonUsage = ButtonUsage.map.get(n2);
        if (buttonUsage != null) {
            return buttonUsage;
        }
        final ButtonUsage buttonUsage2 = new ButtonUsage(n);
        ButtonUsage.map.put(n2, buttonUsage2);
        return buttonUsage2;
    }
