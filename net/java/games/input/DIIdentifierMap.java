...
{
    public static final Component.Identifier.Key getKeyIdentifier(final int n) {
        switch (n) {
            case 1: {
    ...
    public static final Component.Identifier.Button getButtonIdentifier(final int n) {
        switch (n) {
            case 0: {
    ...
    public static final Component.Identifier.Button mapMouseButtonIdentifier(final Component.Identifier.Button button) {
