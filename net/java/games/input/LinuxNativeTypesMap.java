...
class LinuxNativeTypesMap
{
    ...
    public static final Controller.Type guessButtonTrait(final int n) {
        switch (n) {
            case 288:
            case 289:
            case 290:
    ...
    public static Controller.PortType getPortType(final int n) {
        switch (n) {
            case 20: {
    ...
    public static Component.Identifier getRelAxisID(final int n) {
        Component.Identifier slider_VELOCITY = LinuxNativeTypesMap.INSTANCE.relAxesIDs[n];
        if (slider_VELOCITY == null) {
            slider_VELOCITY = Component.Identifier.Axis.SLIDER_VELOCITY;
        }
        return slider_VELOCITY;
    }
    
    public static Component.Identifier getAbsAxisID(final int n) {
        Component.Identifier slider = LinuxNativeTypesMap.INSTANCE.absAxesIDs[n];
        if (slider == null) {
            slider = Component.Identifier.Axis.SLIDER;
        }
        return slider;
    }
    
    public static Component.Identifier getButtonID(final int n) {
        Component.Identifier unknown = LinuxNativeTypesMap.INSTANCE.buttonIDs[n];
        if (unknown == null) {
            unknown = Component.Identifier.Key.UNKNOWN;
        }
        return unknown;
    }
    ...
    static {
        ...
        LinuxNativeTypesMap.log = Logger.getLogger(((LinuxNativeTypesMap.class$net$java$games$input$LinuxNativeTypesMap == null) ? (LinuxNativeTypesMap.class$net$java$games$input$LinuxNativeTypesMap = class$("net.java.games.input.LinuxNativeTypesMap")) : LinuxNativeTypesMap.class$net$java$games$input$LinuxNativeTypesMap).getName());
    }
}
