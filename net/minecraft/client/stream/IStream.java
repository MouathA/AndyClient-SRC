...
public interface IStream
{
    ...
    public enum AuthFailureReason
    {
        ...
        static {
            __OBFID = "CL_00001813";
            ENUM$VALUES = new AuthFailureReason[] { AuthFailureReason.ERROR, AuthFailureReason.INVALID_TOKEN };
            $VALUES = new AuthFailureReason[] { AuthFailureReason.ERROR, AuthFailureReason.INVALID_TOKEN };
        }
        
        private AuthFailureReason(final String s, final int n, final String s2, final int n2) {
        }
    }
}
