...
public class GuiTextField extends Gui
{
    ...
    public GuiTextField(final int field_175208_g, final FontRenderer fontRendererInstance, final int xPosition, final int yPosition, final int width, final int height) {
        this.presetString = "";
        this.text = "";
    ...
    public void mouseClicked(final int n, final int n2, final int n3) {
        final boolean focused = n >= this.xPosition && n < this.xPosition + GuiTextField.width && n2 >= this.yPosition && n2 < this.yPosition + GuiTextField.height;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                Gui.drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + GuiTextField.width + 1, this.yPosition + GuiTextField.height + 1, -6250336);
                Gui.drawRect(this.xPosition, this.yPosition, this.xPosition + GuiTextField.width, this.yPosition + GuiTextField.height, -16777216);
                if (Designs.Classic) {
                    Gui.drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + GuiTextField.width + 1, this.yPosition + GuiTextField.height + 1, -21455);
                    Gui.drawRect(this.xPosition, this.yPosition, this.xPosition + GuiTextField.width, this.yPosition + GuiTextField.height, -16777216);
                }
            }
            ...
            final int n4 = this.enableBackgroundDrawing ? (this.yPosition + (GuiTextField.height - 8) / 2) : this.yPosition;
            ...
            if (!b) {
                n5 = ((n2 > 0) ? (n3 + GuiTextField.width) : n3);
            }
            else if (b3) {
                n5 = func_175063_a - 1;
                --func_175063_a;
            ...
            if (b2) {
                if (b3) {
                    ...
                    this.fontRendererInstance.func_175063_a("_", (float)n5, (float)n4, n);
                }
            }
            if (length != n2) {
    ...
    private void drawCursorVertical(int n, int n2, int n3, int n4) {
        ...
        if (n3 > this.xPosition + GuiTextField.width) {
            n3 = this.xPosition + GuiTextField.width;
        }
        if (n > this.xPosition + GuiTextField.width) {
            n = this.xPosition + GuiTextField.width;
        }
    ...
    public int getWidth() {
        return this.getEnableBackgroundDrawing() ? (GuiTextField.width - 8) : GuiTextField.width;
    }
