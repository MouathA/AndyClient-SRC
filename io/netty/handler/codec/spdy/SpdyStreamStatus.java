...
public class SpdyStreamStatus implements Comparable
{
    ...
    public static SpdyStreamStatus valueOf(final int n) {
        if (n == 0) {
    ...
    public int compareTo(final SpdyStreamStatus spdyStreamStatus) {
        return this.code() - spdyStreamStatus.code();
    }
    
    @Override
    public int compareTo(final Object o) {
        return this.compareTo((SpdyStreamStatus)o);
    }
