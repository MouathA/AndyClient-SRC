...
final class SpdyCodecUtil
{
    ...
    static void validateHeaderName(final String s) {
        ...
        if (s.length() > 65535) {
            throw new IllegalArgumentException("name exceeds allowable length: " + s);
        }
        while (0 < s.length()) {
            final char char1 = s.charAt(0);
            if (char1 == '\0') {
                throw new IllegalArgumentException("name contains null character: " + s);
            }
            if (char1 > '\u007f') {
                throw new IllegalArgumentException("name contains non-ascii character: " + s);
            }
            int n = 0;
            ++n;
        }
    ...
    static void validateHeaderValue(final String s) {
        if (s == null) {
            throw new NullPointerException("value");
        }
        while (0 < s.length()) {
            if (s.charAt(0) == '\0') {
                throw new IllegalArgumentException("value contains null character: " + s);
            }
            int n = 0;
            ++n;
        }
