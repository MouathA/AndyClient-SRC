...
public class WebSocketServerHandshaker08 extends WebSocketServerHandshaker
{
    ...
    public WebSocketServerHandshaker08(final String s, final String s2, final boolean allowExtensions, final int n) {
        super(WebSocketVersion.V08, s, s2, n);
    ...
    protected FullHttpResponse newHandshakeResponse(final FullHttpRequest fullHttpRequest, final HttpHeaders httpHeaders) {
        ...
        if (WebSocketServerHandshaker08.logger.isDebugEnabled()) {
            WebSocketServerHandshaker08.logger.debug("WebSocket version 08 server handshake key: {}, response: {}", value, base64);
        }
        ...
        if (value2 != null) {
            ...
            if (selectSubprotocol == null) {
                if (WebSocketServerHandshaker08.logger.isDebugEnabled()) {
                    WebSocketServerHandshaker08.logger.debug("Requested subprotocol(s) not supported: {}", value2);
                }
            }
            else {
