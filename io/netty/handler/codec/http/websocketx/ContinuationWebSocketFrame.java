...
public class ContinuationWebSocketFrame extends WebSocketFrame
{
    ...
    public ContinuationWebSocketFrame(final ByteBuf byteBuf) {
        super(byteBuf);
    }
    
    public ContinuationWebSocketFrame(final boolean b, final int n, final ByteBuf byteBuf) {
        super(b, n, byteBuf);
    }
    
    public ContinuationWebSocketFrame(final boolean b, final int n, final String s) {
        this(b, n, fromText(s));
    }
    ...
    @Override
    public ContinuationWebSocketFrame retain(final int n) {
        super.retain(n);
        return this;
    }
