...
public class WebSocketClientHandshaker07 extends WebSocketClientHandshaker
{
    ...
    public WebSocketClientHandshaker07(final URI uri, final WebSocketVersion webSocketVersion, final String s, final boolean allowExtensions, final HttpHeaders httpHeaders, final int n) {
    ...
    protected FullHttpRequest newHandshakeRequest() {
        ...
        if (WebSocketClientHandshaker07.logger.isDebugEnabled()) {
            WebSocketClientHandshaker07.logger.debug("WebSocket version 07 client handshake key: {}, expected response: {}", base64, this.expectedChallengeResponseString);
        }
