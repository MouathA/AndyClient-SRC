...
public class HttpResponseStatus implements Comparable
{
    ...
    public static HttpResponseStatus valueOf(final int n) {
        switch (n) {
            case 100: {
            ...
            default: {
                ...
                return new HttpResponseStatus(n, s + " (" + n + ')');
            }
        }
    }
    
    public HttpResponseStatus(final int n, final String s) {
        this(n, s, false);
    }
    
    private HttpResponseStatus(final int code, final String reasonPhrase, final boolean b) {
        if (code < 0) {
        ...
        while (0 < reasonPhrase.length()) {
            switch (reasonPhrase.charAt(0)) {
                case '\n':
                case '\r': {
    ...
    public int compareTo(final HttpResponseStatus httpResponseStatus) {
        return this.code() - httpResponseStatus.code();
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder(this.reasonPhrase.length() + 5);
        sb.append(this.code);
        sb.append(' ');
    ...
    public int compareTo(final Object o) {
        return this.compareTo((HttpResponseStatus)o);
    }
