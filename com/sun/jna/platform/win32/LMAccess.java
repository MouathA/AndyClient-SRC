...
public interface LMAccess extends StdCallLibrary
{
    ...
    public static class GROUP_INFO_3 extends Structure
    {
        ...
        public GROUP_INFO_3(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
    ...
    public static class GROUP_INFO_2 extends Structure
    {
        ...
        public GROUP_INFO_2(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
    ...
    public static class GROUP_INFO_1 extends Structure
    {
        ...
        public GROUP_INFO_1(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
    ...
    public static class GROUP_INFO_0 extends Structure
    {
        ...
        public GROUP_INFO_0(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
    ...
    public static class LOCALGROUP_USERS_INFO_0 extends Structure
    {
        ...
        public LOCALGROUP_USERS_INFO_0(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
    ...
    public static class GROUP_USERS_INFO_0 extends Structure
    {
        ...
        public GROUP_USERS_INFO_0(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
    ...
    public static class USER_INFO_23 extends Structure
    {
        ...
        public USER_INFO_23(final Pointer pointer) {
    ...
    public static class USER_INFO_1 extends Structure
    {
        ...
        public USER_INFO_1(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
    ...
    public static class USER_INFO_0 extends Structure
    {
        ...
        public USER_INFO_0(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
    ...
    public static class LOCALGROUP_INFO_1 extends Structure
    {
        ...
        public LOCALGROUP_INFO_1(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
    ...
    public static class LOCALGROUP_INFO_0 extends Structure
    {
        ...
        public LOCALGROUP_INFO_0(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
