...
public interface WinNT extends WinError, WinDef, WinBase, BaseTSD
{
    ...
    public static class HANDLE extends PointerType
    {
        ...
        public HANDLE(final Pointer pointer) {
        ...
        public Object fromNative(final Object o, final FromNativeContext fromNativeContext) {
            ...
            if (WinBase.INVALID_HANDLE_VALUE.equals(fromNative)) {
    ...
    {
        public ACCESS_DENIED_ACE(final Pointer pointer) {
            super(pointer);
        }
    }
    ...
    public abstract static class ACCESS_ACEStructure extends ACEStructure
    {
        ...
        public ACCESS_ACEStructure(final Pointer pointer) {
            super(pointer);
            this.read();
            this.psid = new PSID(pointer.getByteArray(8, super.AceSize - this.size() + 4));
        }
    }
    ...
    public static class PSID extends Structure
    {
        ...
        public PSID(final byte[] array) {
            super(new Memory(array.length));
            this.getPointer().write(0L, array, 0, array.length);
            this.read();
        }
        
        public PSID(final int n) {
            super(new Memory(n));
        }
        
        public PSID(final Pointer pointer) {
            super(pointer);
            this.read();
        }
        
        public byte[] getBytes() {
            return this.getPointer().getByteArray(0L, Advapi32.INSTANCE.GetLengthSid(this));
        }
    ...
    public abstract static class ACEStructure extends Structure
    {
        ...
        public ACEStructure(final Pointer pointer) {
            super(pointer);
        }
    ...
    {
        public ACCESS_ALLOWED_ACE(final Pointer pointer) {
            super(pointer);
        }
    }
    ...
    {
        public ACE_HEADER(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
    ...
    public static class SECURITY_DESCRIPTOR_RELATIVE extends Structure
    {
        ...
        public SECURITY_DESCRIPTOR_RELATIVE(final byte[] array) {
            super(new Memory(array.length));
            this.DACL = null;
            this.getPointer().write(0L, array, 0, array.length);
            this.setDacl();
    ...
    public static class ACL extends Structure
    {
        ...
        public ACL(final Pointer pointer) {
            ...
            int size = this.size();
            while (0 < this.AceCount) {
                final Pointer share = pointer.share(size);
                final byte byte1 = share.getByte(0L);
                ACCESS_ACEStructure access_ACEStructure = null;
                switch (byte1) {
                    case 0: {
                        access_ACEStructure = new ACCESS_ALLOWED_ACE(share);
                        break;
                    }
                    case 1: {
                        access_ACEStructure = new ACCESS_DENIED_ACE(share);
                        break;
                    }
                    default: {
                        throw new IllegalArgumentException("Unknwon ACE type " + byte1);
                    }
                }
                this.ACEs[0] = access_ACEStructure;
                size += access_ACEStructure.AceSize;
                int n = 0;
                ++n;
            }
        }
    ...
    public static class SECURITY_DESCRIPTOR extends Structure
    {
        ...
        public SECURITY_DESCRIPTOR(final Pointer pointer) {
            super(pointer);
        }
    ...
    public static class OSVERSIONINFOEX extends Structure
    {
        ...
        public OSVERSIONINFOEX(final Pointer pointer) {
    ...
    public static class OSVERSIONINFO extends Structure
    {
        ...
        public OSVERSIONINFO(final Pointer pointer) {
            this.useMemory(pointer);
            this.read();
        }
    }
    ...
    public static class HANDLEByReference extends ByReference
    {
        ...
        public HANDLEByReference(final HANDLE value) {
            super(Pointer.SIZE);
            this.setValue(value);
        }
        
        public void setValue(final HANDLE handle) {
    ...
    public static class FILE_NOTIFY_INFORMATION extends Structure
    {
        ...
        public FILE_NOTIFY_INFORMATION(final int n) {
            this.FileName = new char[1];
            if (n < this.size()) {
        ...
        public FILE_NOTIFY_INFORMATION next() {
            ...
            final FILE_NOTIFY_INFORMATION file_NOTIFY_INFORMATION = new FILE_NOTIFY_INFORMATION();
    ...
    public static class TOKEN_PRIVILEGES extends Structure
    {
        ...
        public TOKEN_PRIVILEGES(final int n) {
            this.PrivilegeCount = new DWORD((long)n);
    ...
    public static class TOKEN_GROUPS extends Structure
    {
        ...
        public TOKEN_GROUPS(final Pointer pointer) {
            super(pointer);
            this.read();
        }
        
        public TOKEN_GROUPS(final int n) {
            super(new Memory(n));
        }
    ...
    public static class SID_AND_ATTRIBUTES extends Structure
    {
        ...
        public SID_AND_ATTRIBUTES(final Pointer pointer) {
            super(pointer);
        }
    }
    ...
    public static class TOKEN_USER extends Structure
    {
        ...
        public TOKEN_USER(final Pointer pointer) {
            super(pointer);
            this.read();
        }
        
        public TOKEN_USER(final int n) {
            super(new Memory(n));
        }
    }
    ...
    public static class PSIDByReference extends ByReference
    {
        ...
        public PSIDByReference(final PSID value) {
            super(Pointer.SIZE);
            this.setValue(value);
        }
        
        public void setValue(final PSID psid) {
    ...
    public static class TOKEN_OWNER extends Structure
    {
        ...
        public TOKEN_OWNER(final int n) {
            super(new Memory(n));
        }
        
        public TOKEN_OWNER(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    }
