...
public interface WinUser extends StdCallLibrary, WinDef
{
    ...
    public static class MOUSEINPUT extends Structure
    {
        ...
        public MOUSEINPUT(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    ...
    public static class KEYBDINPUT extends Structure
    {
        ...
        public KEYBDINPUT(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    ...
    public static class INPUT extends Structure
    {
        ...
        public INPUT(final Pointer pointer) {
            super(pointer);
            this.input = new INPUT_UNION();
            this.read();
        }
        ...
        public static class INPUT_UNION extends Union
        {
            ...
            public INPUT_UNION(final Pointer pointer) {
                super(pointer);
                this.read();
            }
        }
    ...
    public static class HARDWAREINPUT extends Structure
    {
        ...
        public HARDWAREINPUT(final Pointer pointer) {
            super(pointer);
            this.read();
        }
    ...
    public static class SIZE extends Structure
    {
        ...
        public SIZE(final int cx, final int cy) {
            this.cx = cx;
            this.cy = cy;
        }
    }
