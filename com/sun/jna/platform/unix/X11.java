...
public interface X11 extends Library
{
    ...
    public static class XID extends NativeLong
    {
        ...
        public Object fromNative(final Object o, final FromNativeContext fromNativeContext) {
            ...
            return new XID(((Number)o).longValue());
        }
    ...
    public static class Window extends Drawable
    {
        ...
        public Object fromNative(final Object o, final FromNativeContext fromNativeContext) {
            ...
            return new Window(((Number)o).longValue());
        }
    ...
    public static class Drawable extends XID
    {
        ...
        public Object fromNative(final Object o, final FromNativeContext fromNativeContext) {
            ...
            return new Drawable(((Number)o).longValue());
        }
    ...
    public static class Colormap extends XID
    {
        ...
        public Object fromNative(final Object o, final FromNativeContext fromNativeContext) {
            ...
            return new Colormap(((Number)o).longValue());
        }
    ...
    public static class Pixmap extends Drawable
    {
        ...
        public Object fromNative(final Object o, final FromNativeContext fromNativeContext) {
            ...
            return new Pixmap(((Number)o).longValue());
        }
    ...
    public static class Font extends XID
    {
        ...
        public Object fromNative(final Object o, final FromNativeContext fromNativeContext) {
            ...
            return new Font(((Number)o).longValue());
        }
    ...
    public static class Cursor extends XID
    {
        ...
        public Object fromNative(final Object o, final FromNativeContext fromNativeContext) {
            ...
            return new Cursor(((Number)o).longValue());
        }
    ...
    public interface Xrender extends Library
    {
        ...
        public static class PictFormat extends NativeLong
        {
            ...
            public PictFormat(final long n) {
                super(n);
            }
    ...
    public static class KeySym extends XID
    {
        ...
        public Object fromNative(final Object o, final FromNativeContext fromNativeContext) {
            ...
            return new KeySym(((Number)o).longValue());
        }
    ...
    public static class AtomByReference extends ByReference
    {
        ...
        public Atom getValue() {
            return (Atom)new Atom().fromNative(this.getPointer().getNativeLong(0L), null);
        }
    }
}
