...
{
    private static final Object2ObjectOpenHashMap ACHIEVEMENTS;
    private static final Set SPECIAL_ACHIEVEMENTS;
    
    private static void add(final String s, final String s2) {
        AchievementTranslationMapping.ACHIEVEMENTS.put(s, s2);
    }
    
    private static void addSpecial(final String s, final String s2) {
        add(s, s2);
        AchievementTranslationMapping.SPECIAL_ACHIEVEMENTS.add(s);
    }
    
    public static String get(final String s) {
        return (String)AchievementTranslationMapping.ACHIEVEMENTS.get(s);
    }
    
    public static boolean isSpecial(final String s) {
        return AchievementTranslationMapping.SPECIAL_ACHIEVEMENTS.contains(s);
    }
    
    static {
        ACHIEVEMENTS = new Object2ObjectOpenHashMap(150, 0.99f);
        SPECIAL_ACHIEVEMENTS = new HashSet(10);
