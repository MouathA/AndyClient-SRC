...
public class Chunk1_16Type extends Type
{
    ...
    public Chunk read(final ByteBuf byteBuf) throws Exception {
        ...
        final boolean boolean2 = byteBuf.readBoolean();
        ...
        return new BaseChunk(int1, int2, boolean1, boolean2, primitive, array2, array, compoundTag, list);
    }
    ...
    public void write(final ByteBuf byteBuf, final Chunk chunk) throws Exception {
        ...
        buffer.release();
        Type.NBT_ARRAY.write(byteBuf, chunk.getBlockEntities().toArray(Chunk1_16Type.EMPTY_COMPOUNDS));
    }
