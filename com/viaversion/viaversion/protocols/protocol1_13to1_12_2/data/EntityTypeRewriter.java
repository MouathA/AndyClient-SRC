...
public class EntityTypeRewriter
{
    ...
    private static void registerEntity(final int n, final int n2) {
        EntityTypeRewriter.ENTITY_TYPES.put(n, n2);
    }
    
    public static int getNewId(final int n) {
        return EntityTypeRewriter.ENTITY_TYPES.getOrDefault(n, n);
    }
