...
public final class JsonTreeReader extends JsonReader
{
    ...
    public String getPath() {
        ...
        while (0 < this.stackSize) {
            int n = 0;
            if (this.stack[0] instanceof JsonArray) {
                final Object[] stack = this.stack;
                ++n;
                if (stack[0] instanceof Iterator) {
                    append.append('[').append(this.pathIndices[0]).append(']');
                }
            }
            else if (this.stack[0] instanceof JsonObject) {
                final Object[] stack2 = this.stack;
                ++n;
                if (stack2[0] instanceof Iterator) {
                    append.append('.');
