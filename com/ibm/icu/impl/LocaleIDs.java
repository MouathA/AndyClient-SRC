...
public class LocaleIDs
{
    ...
    public static String getISO3Country(final String s) {
        final int index = findIndex(LocaleIDs._countries, s);
        if (index >= 0) {
            return LocaleIDs._countries3[index];
        }
        final int index2 = findIndex(LocaleIDs._obsoleteCountries, s);
        if (index2 >= 0) {
            return LocaleIDs._obsoleteCountries3[index2];
        }
        return "";
    }
    
    public static String getISO3Language(final String s) {
        final int index = findIndex(LocaleIDs._languages, s);
        if (index >= 0) {
            return LocaleIDs._languages3[index];
        }
        final int index2 = findIndex(LocaleIDs._obsoleteLanguages, s);
        if (index2 >= 0) {
            return LocaleIDs._obsoleteLanguages3[index2];
        }
        return "";
    }
    
    public static String threeToTwoLetterLanguage(final String s) {
        final int index = findIndex(LocaleIDs._languages3, s);
        if (index >= 0) {
            return LocaleIDs._languages[index];
        }
        final int index2 = findIndex(LocaleIDs._obsoleteLanguages3, s);
        if (index2 >= 0) {
            return LocaleIDs._obsoleteLanguages[index2];
        }
        return null;
    }
    
    public static String threeToTwoLetterRegion(final String s) {
        final int index = findIndex(LocaleIDs._countries3, s);
        if (index >= 0) {
            return LocaleIDs._countries[index];
        }
        final int index2 = findIndex(LocaleIDs._obsoleteCountries3, s);
        if (index2 >= 0) {
            return LocaleIDs._obsoleteCountries[index2];
        }
        return null;
    }
    
    private static int findIndex(final String[] array, final String s) {
