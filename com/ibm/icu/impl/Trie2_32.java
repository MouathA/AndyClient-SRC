...
public class Trie2_32 extends Trie2
{
    ...
    public static Trie2_32 createFromSerialized(final InputStream inputStream) throws IOException {
    ...
    public final int get(final int n) {
        if (n >= 0) {
            if (n < 55296 || (n > 56319 && n <= 65535)) {
                return this.data32[(this.index[n >> 5] << 2) + (n & 0x1F)];
            }
            if (n <= 65535) {
                return this.data32[(this.index[2048 + (n - 55296 >> 5)] << 2) + (n & 0x1F)];
            }
            if (n < this.highStart) {
                return this.data32[(this.index[this.index[2080 + (n >> 11)] + (n >> 5 & 0x3F)] << 2) + (n & 0x1F)];
            }
            if (n <= 1114111) {
    ...
    public int getFromU16SingleLead(final char c) {
        return this.data32[(this.index[c >> 5] << 2) + (c & '\u001f')];
    }
    ...
    public int serialize(final OutputStream outputStream) throws IOException {
        ...
        while (0 < this.dataLength) {
            dataOutputStream.writeInt(this.data32[0]);
            int n2 = 0;
            ++n2;
        }
        final int n3 = 0 + this.dataLength * 4;
        return 0;
    }
        ...
        while (true) {
            while (i < n2) {
                if (i < 55296 || (i > 56319 && i <= 65535)) {
                    ...
                    if (n3 == this.data32[this.highValueIndex]) {
                        i = n2;
                        break;
                    }
                    break;
