...
public class Gomb extends GuiButton
{
    private String src;
    
    public Gomb(final int n, final int n2, final int n3, final String s, final String s2) {
        this(n, n2, n3, 200, 20, s, s2);
    }
    
    public Gomb(final int n, final int n2, final int n3, final int n4, final int n5, final String s, final String src) {
