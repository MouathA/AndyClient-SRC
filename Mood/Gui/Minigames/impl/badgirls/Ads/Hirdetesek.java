...
public class Hirdetesek
{
    ...
    static {
        Hirdetesek.GRAF_OPTIONS = Arrays.asList(new ResourceLocation("MooDTool/badminecraftgirls/xDDD.jpg"), new ResourceLocation("MooDTool/badminecraftgirls/xDDD2.jpg"), new ResourceLocation("MooDTool/badminecraftgirls/xDDD3.jpg"));
    }
    ...
    public void render(final int n, final int n2, final int n3) {
        if (this.timerTaskDefault.hasTimeReached(8000L)) {
            this.entries.add(new SidEntry(new Random().nextInt(n - 9), Hirdetesek.GRAF_OPTIONS.get(new Random().nextInt(3))));
