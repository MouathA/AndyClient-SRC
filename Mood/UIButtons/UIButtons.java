package Mood.UIButtons;

import net.minecraft.client.*;
import java.awt.*;
import net.minecraft.client.gui.*;

public class UIButtons extends GuiButton
{
    public UIButtons(final int n, final int n2, final int n3, final String s) {
        this(n, n2, n3, 200, 20, s);
    }
    
    public UIButtons(final int n, final int n2, final int n3, final int n4, final int n5, final String s) {
    ...
    public void drawButton(final Minecraft minecraft, final int n, final int n2) {
        if (this.visible) {
            ...
            drawField(Color.DARK_GRAY.getRGB(), color.getRGB(), this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height);
