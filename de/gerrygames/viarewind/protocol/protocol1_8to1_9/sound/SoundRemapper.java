...
{
    private static final HashMap sounds1_9;
    private static final HashMap sound1_9to1_8;
    private static int id;
    
    private static void register1_9Sound(final String s) {
        SoundRemapper.sounds1_9.put(SoundRemapper.id++, s);
    }
    
    private static void registerSoundRemapping(final String s, final String s2) {
        SoundRemapper.sound1_9to1_8.put(s, s2);
    }
    
    public static String oldNameFromId(final int n) {
        final String s = SoundRemapper.sounds1_9.get(n);
        if (s == null) {
            return null;
        }
        return getOldName(s);
    ...
    public static String getOldName(final String s) {
        return SoundRemapper.sound1_9to1_8.getOrDefault(s, s);
    }
    
    static {
        sounds1_9 = new HashMap();
        sound1_9to1_8 = new HashMap();
