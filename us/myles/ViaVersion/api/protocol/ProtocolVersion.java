...
public class ProtocolVersion
{
    ...
    private static final List versionList;
    ...
    public static ProtocolVersion register(final int n, final int n2, final String s, final VersionRange versionRange) {
        ...
        ProtocolVersion.versionList.add(protocolVersion);
    ...
    public static int getIndex(final ProtocolVersion protocolVersion) {
        return ProtocolVersion.versionList.indexOf(protocolVersion);
    }
    
    public static List getProtocols() {
        return Collections.unmodifiableList((List<?>)new ArrayList<Object>(ProtocolVersion.versions.values()));
    }
